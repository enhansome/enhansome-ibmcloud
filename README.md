...
* [carbon](https://github.com/carbon-design-system/carbon) ⭐ 9,446 | 🐛 1,031 | 🌐 JavaScript | 📅 2026-09-11 - A design system built by IBM.
* [carbon-components-svelte](https://github.com/IBM/carbon-components-svelte) ⭐ 2,906 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-11 - Svelte implementation of the Carbon Design System.
...
* [gatsby-theme-carbon](https://github.com/carbon-design-system/gatsby-theme-carbon) ⭐ 357 | 🐛 68 | 🌐 MDX | 📅 2026-09-11 - A Carbon inspired Gatsby theme.
...
* [ibm-dotcom-library](https://github.com/carbon-design-system/ibm-dotcom-library) ⭐ 294 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-11 - IBM.com library based on the Carbon Design System for IBM.
...
* [carbon-addons-angular](https://github.com/IBM/carbon-addons-angular) ⭐ 4 | 🐛 6 | 🌐 TypeScript | 📅 2025-09-17 - Common Addons for Carbon Angular projects.
...
* [Cloud Foundry CLI](https://github.com/cloudfoundry/cli) ⭐ 1,934 | 🐛 86 | 🌐 Go | 📅 2026-09-09 - The official command line client for Cloud Foundry.
...
* [terraform-provider-ibm](https://github.com/IBM-Cloud/terraform-provider-ibm) ⭐ 361 | 🐛 805 | 🌐 Go | 📅 2026-09-11 - Terraform IBM Cloud provider.
...
* [charts](https://github.com/IBM/charts) ⭐ 311 | 🐛 4 | 🌐 Go Template | 📅 2026-09-11 - The IBM/charts repository provides helm charts for IBM and Third Party middleware.
...
* [cloud-pak](https://github.com/IBM/cloud-pak) ⭐ 148 | 🐛 7 | 🌐 Standard ML | 📅 2026-09-11 - IBM Cloud Paks are enterprise-grade containerized software by combining container images with enterprise capabilities for deployment in production use cases with integrations for management and lifecycle operations. Features such as pre-configured deployments based on product expertise, rolling upgrades, rollbacks, security/vulnerability testing.
...
* [max-image-resolution-enhancer](https://github.com/IBM/MAX-Image-Resolution-Enhancer) ⭐ 1,042 | 🐛 17 | 🌐 Python | 📅 2025-09-17 - Upscale an image by a factor of 4, while generating photo-realistic details.
