...
* [carbon](https://github.com/carbon-design-system/carbon) ⭐ 9,474 | 🐛 1,036 | 🌐 JavaScript | 📅 2026-09-21 - A design system built by IBM.
* [carbon-components-svelte](https://github.com/IBM/carbon-components-svelte) ⭐ 2,908 | 🐛 97 | 🌐 TypeScript | 📅 2026-09-21 - Svelte implementation of the Carbon Design System.
...
* [terraform-provider-ibm](https://github.com/IBM-Cloud/terraform-provider-ibm) ⭐ 362 | 🐛 810 | 🌐 Go | 📅 2026-09-17 - Terraform IBM Cloud provider.
...
* [charts](https://github.com/IBM/charts) ⭐ 312 | 🐛 3 | 🌐 Go Template | 📅 2026-09-21 - The IBM/charts repository provides helm charts for IBM and Third Party middleware.
...
* [cloud-pak](https://github.com/IBM/cloud-pak) ⭐ 147 | 🐛 7 | 🌐 Standard ML | 📅 2026-09-21 - IBM Cloud Paks are enterprise-grade containerized software by combining container images with enterprise capabilities for deployment in production use cases with integrations for management and lifecycle operations. Features such as pre-configured deployments based on product expertise, rolling upgrades, rollbacks, security/vulnerability testing.
