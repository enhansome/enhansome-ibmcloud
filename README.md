...
* [carbon](https://github.com/carbon-design-system/carbon) ⭐ 9,437 | 🐛 1,033 | 🌐 JavaScript | 📅 2026-09-07 - A design system built by IBM.
* [carbon-components-svelte](https://github.com/IBM/carbon-components-svelte) ⭐ 2,906 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-07 - Svelte implementation of the Carbon Design System.
* [carbon-design-kit](https://github.com/carbon-design-system/carbon-design-kit) ⭐ 1,108 | 🐛 82 | 📅 2025-08-21 - A versioned, comprehensive kit of the Carbon Design System visual assets (components, iconography, color palettes, grids, templates).
...
* [carbon-charts](https://github.com/carbon-design-system/carbon-charts) ⭐ 1,049 | 🐛 275 | 🌐 HTML | 📅 2026-09-04 - 📊 📈 Reusable charts implemented using D3 & typescript.
* [carbon-components-vue](https://github.com/carbon-design-system/carbon-components-vue) ⭐ 651 | 🐛 26 | 🌐 JavaScript | 📅 2026-09-03 - Vue implementation of the Carbon Design System.
* [carbon-components-angular](https://github.com/IBM/carbon-components-angular) ⭐ 566 | 🐛 239 | 🌐 TypeScript | 📅 2026-09-03 - An Angular implementation of the Carbon Design System for IBM.
...
* [carbon-icons-svelte](https://github.com/IBM/carbon-icons-svelte) ⭐ 459 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-27 - Svelte components for icons in digital and software products using the Carbon Design System.
* [gatsby-theme-carbon](https://github.com/carbon-design-system/gatsby-theme-carbon) ⭐ 357 | 🐛 68 | 🌐 MDX | 📅 2026-09-02 - A Carbon inspired Gatsby theme.
* [carbon-website](https://github.com/carbon-design-system/carbon-website) ⭐ 329 | 🐛 127 | 🌐 MDX | 📅 2026-08-27 - The website for the Carbon Design System.
* [ibm-dotcom-library](https://github.com/carbon-design-system/ibm-dotcom-library) ⭐ 294 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-04 - IBM.com library based on the Carbon Design System for IBM.
...
* [carbon-language-website](https://github.com/carbon-design-system/design-language-website) ⭐ 100 | 🐛 2 | 🌐 CSS | 📅 2026-09-06 - IBM Design Language website.
...
* [carbon-icons-angular](https://github.com/carbon-design-system/carbon-icons-angular) ⭐ 16 | 🐛 67 | 🌐 JavaScript | 📅 2023-07-12 - Carbon icons, in Angular!
* [carbon-sandbox](https://github.com/carbon-design-system/carbon-sandbox) ⭐ 13 | 🐛 19 | 🌐 CSS | 📅 2024-05-23 - A theme playground for Carbon Components.
* [carbon-addons-angular](https://github.com/IBM/carbon-addons-angular) ⭐ 4 | 🐛 5 | 🌐 TypeScript | 📅 2025-09-17 - Common Addons for Carbon Angular projects.
* [carbon-badges](https://github.com/carbon-design-system/carbon-badges) ⚠️ Archived - A site to apply for Carbon badges.
...
* [Cloud Foundry CLI](https://github.com/cloudfoundry/cli) ⭐ 1,933 | 🐛 85 | 🌐 Go | 📅 2026-09-07 - The official command line client for Cloud Foundry.
* [IBM Cloud CLI Release](https://github.com/IBM-Cloud/ibm-cloud-cli-release) ⭐ 159 | 🐛 29 | 📅 2026-08-28 - This is the command line client for IBM Cloud.
...
* [terraform-provider-ibm](https://github.com/IBM-Cloud/terraform-provider-ibm) ⭐ 361 | 🐛 810 | 🌐 Go | 📅 2026-09-03 - Terraform IBM Cloud provider.
* [cp4d-deployment](https://github.com/IBM/cp4d-deployment) ⭐ 49 | 🐛 12 | 📅 2026-08-21 - These terraform scripts are developed to deploy CloudPakforData on the public cloud.
* [ibm-spectrum-scale-cloud-install](https://github.com/IBM/ibm-spectrum-scale-cloud-install) ⭐ 32 | 🐛 5 | 🌐 HCL | 📅 2026-09-07 - Cloud Resource Provisioning framework for IBM Spectrum Scale.
...
* [charts](https://github.com/IBM/charts) ⭐ 311 | 🐛 4 | 🌐 Go Template | 📅 2026-09-07 - The IBM/charts repository provides helm charts for IBM and Third Party middleware.
...
* [cloud-pak](https://github.com/IBM/cloud-pak) ⭐ 148 | 🐛 7 | 🌐 Standard ML | 📅 2026-09-07 - IBM Cloud Paks are enterprise-grade containerized software by combining container images with enterprise capabilities for deployment in production use cases with integrations for management and lifecycle operations. Features such as pre-configured deployments based on product expertise, rolling upgrades, rollbacks, security/vulnerability testing.
...
* [kitura-sample](https://github.com/IBM-Swift/Kitura-Sample) ⭐ 80 | 🐛 4 | 🌐 Swift | 📅 2020-09-18 - A sample application that shows how to use various features of Kitura.
...
* [cloud-operators](https://github.com/IBM/cloud-operators) ⭐ 42 | 🐛 36 | 🌐 Go | 📅 2026-09-03 - IBM Public Cloud Service Operator.
...
* [ibm-cloud-go](https://github.com/IBM-Cloud/bluemix-go) ⭐ 38 | 🐛 44 | 🌐 Go | 📅 2026-07-10 - Go library for accessing the IBM Cloud API.
* [kitura-nio](https://github.com/IBM-Swift/Kitura-NIO) ⭐ 37 | 🐛 18 | 🌐 Swift | 📅 2022-10-07 - A networking library for Kitura, based on SwiftNIO.
* [insurance-bot](https://github.com/IBM-Cloud/insurance-bot) ⚠️ Archived - A message based insurance experience.
* [kitura-starter](https://github.com/IBM-Cloud/Kitura-Starter) ⚠️ Archived - Kitura-based server starter application for the IBM Cloud.
* [kitura-session](https://github.com/IBM-Swift/Kitura-Session) ⭐ 19 | 🐛 2 | 🌐 Swift | 📅 2022-10-05 - A pluggable framework for managing user sessions in a Swift server using Kitura.
* [multiple-deployment-options](https://github.com/IBM-Cloud/multiple-deployment-options) ⚠️ Archived - Shows how one service can be deployed to multiple deployment options.
* [kitura-credentials-google](https://github.com/IBM-Swift/Kitura-CredentialsGoogle) ⭐ 9 | 🐛 0 | 🌐 Swift | 📅 2020-11-27 - A plugin for the Kitura-Credentials framework that authenticates using the Google web login.
...
* [cloud-foundry](https://github.com/cloudfoundry/) - IBM Cloud Platform as a Service.
  * [java-buildpack](https://github.com/cloudfoundry/java-buildpack) ⭐ 453 | 🐛 8 | 🌐 Go | 📅 2026-09-04 - Cloud Foundry buildpack for running Java applications.
  * [staticfile-buildpack](https://github.com/cloudfoundry/staticfile-buildpack) ⭐ 203 | 🐛 6 | 🌐 Go | 📅 2026-09-02 - Deploy static HTML/JS/CSS apps to Cloud Foundry.
  * [nodejs-buildpack](https://github.com/cloudfoundry/nodejs-buildpack) ⭐ 175 | 🐛 10 | 🌐 Go | 📅 2026-08-26 - Cloud Foundry buildpack for Node.js.
  * [php-buildpack](https://github.com/cloudfoundry/php-buildpack) ⭐ 141 | 🐛 9 | 🌐 Go | 📅 2026-09-02 - A Cloud Foundry Buildpack for PHP.
  * [python-buildpack](https://github.com/cloudfoundry/python-buildpack) ⭐ 122 | 🐛 8 | 🌐 Go | 📅 2026-08-20 - Cloud Foundry buildpack for the Python Language.
  * [dotnet-buildpack](https://github.com/cloudfoundry/dotnet-core-buildpack) ⭐ 97 | 🐛 79 | 🌐 Go | 📅 2026-08-26 - Cloud Foundry buildpack for .NET Core on Linux.
  ...
  * [ruby-buildpack](https://github.com/cloudfoundry/ruby-buildpack) ⭐ 68 | 🐛 43 | 🌐 Go | 📅 2026-09-02 - Cloud Foundry buildpack for Ruby, Sinatra and Rails.
  * [nginx-buildpack](https://github.com/cloudfoundry/nginx-buildpack) ⭐ 30 | 🐛 9 | 🌐 Go | 📅 2026-09-02 - Cloud Foundry buildpack that provides NGINX.
...
* [openwhisk-darkvisionapp](https://github.com/IBM-Cloud/openwhisk-darkvisionapp) ⚠️ Archived - Discover dark data in videos with IBM Watson and IBM Cloud Functions.
* [openwhisk-visionapp](https://github.com/IBM-Cloud/openwhisk-visionapp) ⚠️ Archived - A sample iOS app for image tagging and face detection built with IBM Cloud Functions.
* [serverless-chatbot](https://github.com/victorshinya/serverless-chatbot) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2020-04-05 - Build your own chatbot using Serverless service (Serverless Architecture/Function-as-a-Service).

## Data & AI

*SDKs and code patterns with Watson services.*

* [speech-to-text-nodejs](https://github.com/watson-developer-cloud/speech-to-text-nodejs) ⭐ 1,113 | 🐛 26 | 🌐 JavaScript | 📅 2023-01-07 - 🎤 Sample Node.js Application for the IBM Watson Speech to Text Service.
* [max-image-resolution-enhancer](https://github.com/IBM/MAX-Image-Resolution-Enhancer) ⭐ 1,041 | 🐛 18 | 🌐 Python | 📅 2025-09-17 - Upscale an image by a factor of 4, while generating photo-realistic details.
...
* [assistant-simple](https://github.com/watson-developer-cloud/assistant-simple) ⭐ 478 | 🐛 22 | 🌐 JavaScript | 📅 2023-01-04 - A simple sample application demonstrating the Watson Assistant API.
* [tone-analyzer-nodejs](https://github.com/watson-developer-cloud/tone-analyzer-nodejs) ⚠️ Archived - Sample Node.js Application for the IBM Tone Analyzer Service.
* [visual-recognition-nodejs](https://github.com/watson-developer-cloud/visual-recognition-nodejs) ⚠️ Archived - 📷 Sample Node.js Application for the IBM Watson Visual Recognition Service.
* [max-object-detector](https://github.com/IBM/MAX-Object-Detector) ⭐ 293 | 🐛 8 | 🌐 Python | 📅 2025-09-17 - Localize and identify multiple objects in a single image.
* [speech-javascript-sdk](https://github.com/watson-developer-cloud/speech-javascript-sdk) ⭐ 263 | 🐛 12 | 🌐 JavaScript | 📅 2026-02-10 - Library for using the IBM Watson Speech to Text and Text to Speech services in web browsers.
* [botkit-middleware](https://github.com/watson-developer-cloud/botkit-middleware) ⭐ 206 | 🐛 27 | 🌐 TypeScript | 📅 2023-01-07 - A middleware to connect Watson Assistant Service to different chat channels using Botkit.
* [node-red-labs](https://github.com/watson-developer-cloud/node-red-labs) ⭐ 205 | 🐛 17 | 📅 2018-05-30 - Node-RED labs on the use of the Watson Developer Cloud services.
* [chatbot-watson-android](https://github.com/IBM-Cloud/chatbot-watson-android) ⚠️ Archived - An Android ChatBot powered by Watson Services - Assistant, Speech-to-Text and Text-to-Speech on IBM Cloud.
* [max-audio-classifier](https://github.com/IBM/MAX-Audio-Classifier) ⭐ 158 | 🐛 7 | 🌐 Python | 📅 2025-09-17 - Identify sounds in short audio clips.
* [natural-language-classifier-nodejs](https://github.com/watson-developer-cloud/natural-language-classifier-nodejs) ⚠️ Archived - See how the classifier service uses natural language to determine the intent behind your question.
* [your-celebrity-match](https://github.com/watson-developer-cloud/your-celebrity-match) ⚠️ Archived - 🌟 The Celebrity Match application uses the Watson Personality Insights Service and Twitter data to identify celebrities on Twitter whose tweets are conceptually closest to yours.
...
* [max-weather-forecaster](https://github.com/IBM/MAX-Weather-Forecaster) ⭐ 71 | 🐛 5 | 🌐 Python | 📅 2025-09-17 - Predict hourly weather features given historical data for a specific location.
...
* [max-audio-embedding-generator](https://github.com/IBM/MAX-Audio-Embedding-Generator) ⭐ 58 | 🐛 5 | 🌐 Python | 📅 2025-09-17 - Generate embedding vectors from audio files.
* [max-text-sentiment-classifier](https://github.com/IBM/MAX-Text-Sentiment-Classifier) ⭐ 56 | 🐛 8 | 🌐 Python | 📅 2025-09-17 - Detect the sentiment captured in short pieces of text.
* [max-toxic-comment-classifier](https://github.com/IBM/MAX-Toxic-Comment-Classifier) ⭐ 56 | 🐛 3 | 🌐 Python | 📅 2025-09-17 - Detect 6 types of toxicity in user comments.
* [max-ocr](https://github.com/IBM/MAX-OCR) ⭐ 51 | 🐛 6 | 🌐 Python | 📅 2025-09-17 - MAX Optical Character Recognition.
* [max-fast-neural-style-transfer](https://github.com/IBM/MAX-Fast-Neural-Style-Transfer) ⭐ 50 | 🐛 6 | 🌐 Python | 📅 2025-09-17 - Generate a new image that mixes the content of a source image with the style of another image.
...
* [max-chinese-phonetic-similarity-estimator](https://github.com/IBM/MAX-Chinese-Phonetic-Similarity-Estimator) ⭐ 38 | 🐛 5 | 🌐 Python | 📅 2025-09-17 - Estimate the phonetic distance between Chinese words and get similar sounding candidate words.
...
* [max-inception-resnet-v2](https://github.com/IBM/MAX-Inception-ResNet-v2) ⭐ 27 | 🐛 5 | 🌐 Python | 📅 2025-09-17 - Identify objects in images using a third-generation deep residual network.
...
* [max-news-text-generator](https://github.com/IBM/MAX-News-Text-Generator) ⭐ 26 | 🐛 5 | 🌐 Python | 📅 2025-09-17 - Generate English-language text similar to the news articles in the One Billion Words data set.
...
* [max-named-entity-tagger](https://github.com/IBM/MAX-Named-Entity-Tagger) ⭐ 25 | 🐛 6 | 🌐 Python | 📅 2025-09-17 - Locate and tag named entities in text.
* [max-sports-video-classifier](https://github.com/IBM/MAX-Sports-Video-Classifier) ⭐ 24 | 🐛 7 | 🌐 Python | 📅 2025-09-17 - Categorize sports videos according to which sport the video depicts.
* [max-audio-sample-generator](https://github.com/IBM/MAX-Audio-Sample-Generator) ⭐ 22 | 🐛 5 | 🌐 Python | 📅 2025-09-17 - Generate short audio clips of speech commands and lo-fi instrumental samples.
* [max-review-text-generator](https://github.com/IBM/MAX-Review-Text-Generator) ⭐ 18 | 🐛 4 | 🌐 Python | 📅 2025-09-17 - Generate English-language text similar to the text in the Yelp® review data set.
* [max-resnet-50](https://github.com/IBM/MAX-ResNet-50) ⭐ 15 | 🐛 5 | 🌐 Python | 📅 2025-09-17 - Identify objects in images using a first-generation deep residual network.
* [max-base](https://github.com/IBM/MAX-Base) ⭐ 12 | 🐛 10 | 🌐 Dockerfile | 📅 2026-08-28 - This is a base image for IBM Model Asset Exchange.
...
* [watson-developer-cloud](https://github.com/watson-developer-cloud) - A collection of REST APIs and SDKs that use cognitive computing to solve complex problems.
  * [node-sdk](https://github.com/watson-developer-cloud/node-sdk) ⭐ 1,473 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-06 - ☄️ Node.js library to access IBM Watson services.
  ...
  * [unity-sdk](https://github.com/watson-developer-cloud/unity-sdk) ⭐ 565 | 🐛 4 | 🌐 C# | 📅 2025-04-22 - 🎮 Unity SDK to use the IBM Watson services.
  * [android-sdk](https://github.com/watson-developer-cloud/android-sdk) ⭐ 148 | 🐛 11 | 🌐 Java | 📅 2021-01-04 - 🔆 Android SDK to use the IBM Watson services.
  * [dotnet-standard-sdk](https://github.com/watson-developer-cloud/dotnet-standard-sdk) ⭐ 148 | 🐛 0 | 🌐 C# | 📅 2026-05-19 - 🆕🆕🆕 .NET Standard library to access Watson Services.
  * [go-sdk](https://github.com/watson-developer-cloud/go-sdk) ⭐ 67 | 🐛 3 | 🌐 Go | 📅 2025-04-22 - 🐭 Go SDK for the IBM Watson services.
  * [ruby-sdk](https://github.com/watson-developer-cloud/ruby-sdk) ⭐ 43 | 🐛 1 | 🌐 Ruby | 📅 2025-04-22 - ♦️ Ruby SDK to use the IBM Watson services.
  * [salesforce-sdk](https://github.com/watson-developer-cloud/salesforce-sdk) ⚠️ Archived - A Salesforce library for communicating with the IBM Watson REST APIs.
  * [openwhisk-sdk](https://github.com/watson-developer-cloud/openwhisk-sdk) ⚠️ Archived - 🆕 SDK for using Watson Services on IBM Cloud Functions (based on Apache Openwhisk).
...
* [IBM Cloud Stencils](https://github.com/ibm-cloud-architecture/ibm-cloud-stencils) ⭐ 128 | 🐛 0 | 📅 2024-10-16 - IBM Cloud Stencils for creating IBM Cloud diagrams with popular diagram tools.
