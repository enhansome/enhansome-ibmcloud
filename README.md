...
* [carbon](https://github.com/carbon-design-system/carbon) ⭐ 9,385 | 🐛 1,009 | 🌐 TypeScript | 📅 2026-08-25 - A design system built by IBM.
...
* [carbon-design-kit](https://github.com/carbon-design-system/carbon-design-kit) ⭐ 1,108 | 🐛 86 | 📅 2025-08-21 - A versioned, comprehensive kit of the Carbon Design System visual assets (components, iconography, color palettes, grids, templates).
...
* [ibm-dotcom-library](https://github.com/carbon-design-system/ibm-dotcom-library) ⭐ 294 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-25 - IBM.com library based on the Carbon Design System for IBM.
...
* [carbon-addons-iot-react](https://github.com/IBM/carbon-addons-iot-react) ⭐ 103 | 🐛 250 | 🌐 JavaScript | 📅 2026-08-25 - This library contains React components shared between all IBM IoT products to unify our look and feel. These widgets are usually based on the carbon-components-react widgets.
...
* [Cloud Foundry CLI](https://github.com/cloudfoundry/cli) ⭐ 1,929 | 🐛 80 | 🌐 Go | 📅 2026-08-24 - The official command line client for Cloud Foundry.
...
* [terraform-provider-ibm](https://github.com/IBM-Cloud/terraform-provider-ibm) ⭐ 360 | 🐛 806 | 🌐 Go | 📅 2026-08-25 - Terraform IBM Cloud provider.
...
* [ibm-spectrum-scale-cloud-install](https://github.com/IBM/ibm-spectrum-scale-cloud-install) ⭐ 32 | 🐛 3 | 🌐 HCL | 📅 2026-08-25 - Cloud Resource Provisioning framework for IBM Spectrum Scale.
...
* [charts](https://github.com/IBM/charts) ⭐ 311 | 🐛 4 | 🌐 Go Template | 📅 2026-08-25 - The IBM/charts repository provides helm charts for IBM and Third Party middleware.
...
* [cloud-pak](https://github.com/IBM/cloud-pak) ⭐ 148 | 🐛 7 | 🌐 Standard ML | 📅 2026-08-25 - IBM Cloud Paks are enterprise-grade containerized software by combining container images with enterprise capabilities for deployment in production use cases with integrations for management and lifecycle operations. Features such as pre-configured deployments based on product expertise, rolling upgrades, rollbacks, security/vulnerability testing.
...
* [cloud-operators](https://github.com/IBM/cloud-operators) ⭐ 42 | 🐛 37 | 🌐 Go | 📅 2026-08-25 - IBM Public Cloud Service Operator.
...
* [cloud-foundry](https://github.com/cloudfoundry/) - IBM Cloud Platform as a Service.
  * [java-buildpack](https://github.com/cloudfoundry/java-buildpack) ⭐ 454 | 🐛 9 | 🌐 Go | 📅 2026-08-25 - Cloud Foundry buildpack for running Java applications.
