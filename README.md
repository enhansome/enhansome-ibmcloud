...
* [carbon](https://github.com/carbon-design-system/carbon) ⭐ 9,406 | 🐛 1,002 | 🌐 JavaScript | 📅 2026-09-02 - A design system built by IBM.
* [carbon-components-svelte](https://github.com/IBM/carbon-components-svelte) ⭐ 2,903 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-02 - Svelte implementation of the Carbon Design System.
...
* [carbon-components-vue](https://github.com/carbon-design-system/carbon-components-vue) ⭐ 651 | 🐛 25 | 🌐 JavaScript | 📅 2026-09-01 - Vue implementation of the Carbon Design System.
* [carbon-components-angular](https://github.com/IBM/carbon-components-angular) ⭐ 564 | 🐛 237 | 🌐 TypeScript | 📅 2026-09-01 - An Angular implementation of the Carbon Design System for IBM.
...
* [carbon-icons-svelte](https://github.com/IBM/carbon-icons-svelte) ⭐ 458 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-27 - Svelte components for icons in digital and software products using the Carbon Design System.
...
* [ibm-dotcom-library](https://github.com/carbon-design-system/ibm-dotcom-library) ⭐ 294 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-02 - IBM.com library based on the Carbon Design System for IBM.
...
* [carbon-language-website](https://github.com/carbon-design-system/design-language-website) ⭐ 100 | 🐛 2 | 🌐 CSS | 📅 2026-09-02 - IBM Design Language website.
...
* [Cloud Foundry CLI](https://github.com/cloudfoundry/cli) ⭐ 1,932 | 🐛 83 | 🌐 Go | 📅 2026-09-02 - The official command line client for Cloud Foundry.
...
* [terraform-provider-ibm](https://github.com/IBM-Cloud/terraform-provider-ibm) ⭐ 360 | 🐛 809 | 🌐 Go | 📅 2026-09-02 - Terraform IBM Cloud provider.
...
* [ibm-spectrum-scale-cloud-install](https://github.com/IBM/ibm-spectrum-scale-cloud-install) ⭐ 32 | 🐛 5 | 🌐 HCL | 📅 2026-09-01 - Cloud Resource Provisioning framework for IBM Spectrum Scale.
...
* [charts](https://github.com/IBM/charts) ⭐ 311 | 🐛 4 | 🌐 Go Template | 📅 2026-09-02 - The IBM/charts repository provides helm charts for IBM and Third Party middleware.
...
* [cloud-pak](https://github.com/IBM/cloud-pak) ⭐ 148 | 🐛 7 | 🌐 Standard ML | 📅 2026-09-02 - IBM Cloud Paks are enterprise-grade containerized software by combining container images with enterprise capabilities for deployment in production use cases with integrations for management and lifecycle operations. Features such as pre-configured deployments based on product expertise, rolling upgrades, rollbacks, security/vulnerability testing.
...
* [cloud-operators](https://github.com/IBM/cloud-operators) ⭐ 42 | 🐛 36 | 🌐 Go | 📅 2026-08-25 - IBM Public Cloud Service Operator.
...
* [cloud-foundry](https://github.com/cloudfoundry/) - IBM Cloud Platform as a Service.
  * [java-buildpack](https://github.com/cloudfoundry/java-buildpack) ⭐ 453 | 🐛 11 | 🌐 Go | 📅 2026-09-02 - Cloud Foundry buildpack for running Java applications.
