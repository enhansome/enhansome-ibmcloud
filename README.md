...
* [carbon](https://github.com/carbon-design-system/carbon) ⭐ 9,441 | 🐛 1,039 | 🌐 JavaScript | 📅 2026-09-10 - A design system built by IBM.
* [carbon-components-svelte](https://github.com/IBM/carbon-components-svelte) ⭐ 2,906 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-10 - Svelte implementation of the Carbon Design System.
...
* [carbon-components-vue](https://github.com/carbon-design-system/carbon-components-vue) ⭐ 651 | 🐛 27 | 🌐 JavaScript | 📅 2026-09-10 - Vue implementation of the Carbon Design System.
* [carbon-components-angular](https://github.com/IBM/carbon-components-angular) ⭐ 566 | 🐛 245 | 🌐 TypeScript | 📅 2026-09-10 - An Angular implementation of the Carbon Design System for IBM.
...
* [ibm-dotcom-library](https://github.com/carbon-design-system/ibm-dotcom-library) ⭐ 294 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-09 - IBM.com library based on the Carbon Design System for IBM.
...
* [carbon-language-website](https://github.com/carbon-design-system/design-language-website) ⭐ 100 | 🐛 1 | 🌐 CSS | 📅 2026-09-10 - IBM Design Language website.
...
* [Cloud Foundry CLI](https://github.com/cloudfoundry/cli) ⭐ 1,934 | 🐛 85 | 🌐 Go | 📅 2026-09-09 - The official command line client for Cloud Foundry.
...
* [terraform-provider-ibm](https://github.com/IBM-Cloud/terraform-provider-ibm) ⭐ 361 | 🐛 807 | 🌐 Go | 📅 2026-09-10 - Terraform IBM Cloud provider.
...
* [ibm-spectrum-scale-cloud-install](https://github.com/IBM/ibm-spectrum-scale-cloud-install) ⭐ 32 | 🐛 5 | 🌐 HCL | 📅 2026-09-10 - Cloud Resource Provisioning framework for IBM Spectrum Scale.
...
* [cloud-pak](https://github.com/IBM/cloud-pak) ⭐ 148 | 🐛 7 | 🌐 Standard ML | 📅 2026-09-10 - IBM Cloud Paks are enterprise-grade containerized software by combining container images with enterprise capabilities for deployment in production use cases with integrations for management and lifecycle operations. Features such as pre-configured deployments based on product expertise, rolling upgrades, rollbacks, security/vulnerability testing.
...
* [cloud-foundry](https://github.com/cloudfoundry/) - IBM Cloud Platform as a Service.
  * [java-buildpack](https://github.com/cloudfoundry/java-buildpack) ⭐ 453 | 🐛 8 | 🌐 Go | 📅 2026-09-10 - Cloud Foundry buildpack for running Java applications.
...
* [max-image-resolution-enhancer](https://github.com/IBM/MAX-Image-Resolution-Enhancer) ⭐ 1,041 | 🐛 17 | 🌐 Python | 📅 2025-09-17 - Upscale an image by a factor of 4, while generating photo-realistic details.
...
* [max-named-entity-tagger](https://github.com/IBM/MAX-Named-Entity-Tagger) ⭐ 25 | 🐛 7 | 🌐 Python | 📅 2025-09-17 - Locate and tag named entities in text.
...
* [max-audio-sample-generator](https://github.com/IBM/MAX-Audio-Sample-Generator) ⭐ 22 | 🐛 6 | 🌐 Python | 📅 2025-09-17 - Generate short audio clips of speech commands and lo-fi instrumental samples.
