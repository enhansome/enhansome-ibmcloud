...
* [carbon](https://github.com/carbon-design-system/carbon) ⭐ 9,368 | 🐛 1,057 | 🌐 JavaScript | 📅 2026-08-18 - A design system built by IBM.
* [carbon-components-svelte](https://github.com/IBM/carbon-components-svelte) ⭐ 2,897 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-18 - Svelte implementation of the Carbon Design System.
* [carbon-design-kit](https://github.com/carbon-design-system/carbon-design-kit) ⭐ 1,105 | 🐛 89 | 📅 2025-08-21 - A versioned, comprehensive kit of the Carbon Design System visual assets (components, iconography, color palettes, grids, templates).
...
* [carbon-charts](https://github.com/carbon-design-system/carbon-charts) ⭐ 1,045 | 🐛 271 | 🌐 HTML | 📅 2026-07-31 - 📊 📈 Reusable charts implemented using D3 & typescript.
...
* [carbon-components-angular](https://github.com/IBM/carbon-components-angular) ⭐ 564 | 🐛 233 | 🌐 TypeScript | 📅 2026-08-17 - An Angular implementation of the Carbon Design System for IBM.
...
* [ibm-dotcom-library](https://github.com/carbon-design-system/ibm-dotcom-library) ⭐ 293 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-18 - IBM.com library based on the Carbon Design System for IBM.
...
* [carbon-language-website](https://github.com/carbon-design-system/design-language-website) ⭐ 100 | 🐛 1 | 🌐 CSS | 📅 2026-08-16 - IBM Design Language website.
...
* [Cloud Foundry CLI](https://github.com/cloudfoundry/cli) ⭐ 1,928 | 🐛 78 | 🌐 Go | 📅 2026-08-17 - The official command line client for Cloud Foundry.
...
* [terraform-provider-ibm](https://github.com/IBM-Cloud/terraform-provider-ibm) ⭐ 360 | 🐛 808 | 🌐 Go | 📅 2026-08-18 - Terraform IBM Cloud provider.
* [cp4d-deployment](https://github.com/IBM/cp4d-deployment) ⭐ 49 | 🐛 12 | 📅 2026-08-14 - These terraform scripts are developed to deploy CloudPakforData on the public cloud.
* [ibm-spectrum-scale-cloud-install](https://github.com/IBM/ibm-spectrum-scale-cloud-install) ⭐ 32 | 🐛 4 | 🌐 HCL | 📅 2026-08-18 - Cloud Resource Provisioning framework for IBM Spectrum Scale.
...
* [charts](https://github.com/IBM/charts) ⭐ 311 | 🐛 4 | 🌐 Go Template | 📅 2026-08-18 - The IBM/charts repository provides helm charts for IBM and Third Party middleware.
...
* [cloud-pak](https://github.com/IBM/cloud-pak) ⭐ 147 | 🐛 7 | 🌐 Standard ML | 📅 2026-08-18 - IBM Cloud Paks are enterprise-grade containerized software by combining container images with enterprise capabilities for deployment in production use cases with integrations for management and lifecycle operations. Features such as pre-configured deployments based on product expertise, rolling upgrades, rollbacks, security/vulnerability testing.
...
* [cloud-operators](https://github.com/IBM/cloud-operators) ⭐ 42 | 🐛 39 | 🌐 Go | 📅 2026-08-06 - IBM Public Cloud Service Operator.
...
* [cloud-foundry](https://github.com/cloudfoundry/) - IBM Cloud Platform as a Service.
  * [java-buildpack](https://github.com/cloudfoundry/java-buildpack) ⭐ 453 | 🐛 10 | 🌐 Go | 📅 2026-08-18 - Cloud Foundry buildpack for running Java applications.
  ...
  * [python-buildpack](https://github.com/cloudfoundry/python-buildpack) ⭐ 122 | 🐛 9 | 🌐 Go | 📅 2026-08-18 - Cloud Foundry buildpack for the Python Language.
  * [dotnet-buildpack](https://github.com/cloudfoundry/dotnet-core-buildpack) ⭐ 97 | 🐛 113 | 🌐 Go | 📅 2026-08-13 - Cloud Foundry buildpack for .NET Core on Linux.
  * [go-buildpack](https://github.com/cloudfoundry/go-buildpack) ⭐ 85 | 🐛 5 | 🌐 Go | 📅 2026-08-13 - Cloud Foundry buildpack for the Go Language.
